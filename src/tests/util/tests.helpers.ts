...
const getMeAPreGeneratedKeyPair = (
    application: string
) => {
...
const verifyEncryptionDecryption = (
    privateKey: string
) => {
...
export { initAndClear, getMeAPreGeneratedKeyPair, verifyKeys, verifyEncryptionDecryption };